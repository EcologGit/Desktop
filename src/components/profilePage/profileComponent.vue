<template>
  <main class="main">
    <section class="card profile-user">
      <img src="../../assets/imgs/profile_photo.png" alt="" class="card-img" />
        ...
        <div class="card-content-wrapping">
          ...
          <div class="user-data">
            ...
            <div class="btns-circle-icon">
              <router-link class="a-circle-icon" to="/settings">
                <img
                  class="cirlce-img"
    ...
    <section class="buttons profile">
      <router-link to="/profile/reports" class="links-width">
      ...
      <router-link to="/profile/statistics" class="links-width">
